...
export default function PlanBuilder() {
  ...
  return (
    <section className="relative">
      <div className="mb-6">
        <h1 className="text-2xl font-extrabold tracking-tight">Tự tạo lịch tập</h1>
      ...
      <div className="sticky top-16 z-10 space-y-3 rounded-2xl bg-white p-4 shadow-soft">
        <div>
          <div className="flex items-end justify-between">
            ...
            <p className="text-sm">
              <span className={`text-lg font-extrabold ${overTarget ? "text-rose-500" : "text-brand-600"}`}>
                {viNum(foodTotal)}
              </span>
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <div className="shrink-0 text-right">
                      <p className="text-lg font-extrabold text-brand-600">{viNum(f.calories)}</p>
    ...
    <div className="space-y-5">
      ...
      <div className="sticky top-16 z-[5] rounded-2xl bg-white p-4 shadow-soft">
        <div className="flex items-end justify-between">
          ...
          <p className="text-lg font-extrabold text-brand-600">~{usedMin}′</p>
        </div>
        <p className="mt-1.5 text-xs text-slate-400">
  ...
  return (
    <div className="space-y-5">
      <div className="rounded-2xl bg-gradient-to-br from-brand-500 to-emerald-600 p-6 text-white shadow-soft">
        ...
        <p className="mt-1 text-3xl font-extrabold">{nutrition.target.toLocaleString("vi-VN")} kcal/ngày</p>
      ...
      <div className="rounded-2xl border border-slate-200 bg-slate-50/80 p-4">
        <p className="text-sm font-extrabold text-slate-900">Điều khoản sử dụng và miễn trừ trách nhiệm y tế</p>
